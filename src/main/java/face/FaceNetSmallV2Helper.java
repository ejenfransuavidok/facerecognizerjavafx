...
import static face.FaceNetSmallV2Model.paddingIndex;
import static face.FaceNetSmallV2Model.reluIndex;

@Slf4j
public class FaceNetSmallV2Helper {
    static final String BASE = "face/";
    ...
    static double[] readWightsValues(String path) throws IOException {
        String collect = Files.lines(Paths.get(FaceNetSmallV2Helper.class.getClassLoader().getResource(path).getFile()))
